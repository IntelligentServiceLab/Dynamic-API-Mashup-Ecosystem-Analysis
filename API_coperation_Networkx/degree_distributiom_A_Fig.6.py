...
if __name__ == "__main__":
    ...
    list_network = [network_05_to_08, network_05_to_11, network_05_to_14, network_05_to_17, network_05_to_19,
                    network_05_to_21]
    ...
    for i in range(1, 7):
        ...
        if i >= 1 and i <= 3:
            ax.set_ylim(0, 3)
            ax.text(0.3, 2, formula, fontdict=font3)
            ax.text(2.5, 2.5, anotation[i - 1], fontdict=font2)
            if i == 1:
                ax.set_ylabel("lgN", font1)
        if i >= 4 and i <= 6:
            ax.set_ylim(0, 3)
            ax.text(0.3, 1.5, formula, fontdict=font3)
            ax.text(2.5, 2.5, anotation[i - 1], fontdict=font2)
            if i == 4:
                ax.set_ylabel("lgN", font1)
        ...
        ax.plot(x, ynew, 'r')
    plt.savefig('E:/IntelligentServiceLab/动态分析论文/picture/3.2 API_coperation/Figure_degreedistribution.svg', format='svg', bbox_inches='tight', dpi=600)
    plt.savefig('E:/IntelligentServiceLab/动态分析论文/picture/3.2 API_coperation/Figure_degreedistribution.png', format='png', dpi=600)
    #plt.savefig('E:/IntelligentServiceLab/动态分析论文/picture/3.2 API_coperation/Figure_degreedistribution.tif', format='tif', dpi=600)
    plt.show()
