...
if __name__ == "__main__":
    ...
    list_network = [network_05_to_06, network_05_to_07, network_05_to_08, network_05_to_09, network_05_to_10,
                    network_05_to_11, network_05_to_12, network_05_to_13, network_05_to_14, network_05_to_15,
                    network_05_to_16, network_05_to_17, network_05_to_18, network_05_to_19, network_05_to_20,
                    network_05_to_21]
    ...
    plt.savefig("E:/IntelligentServiceLab/动态分析论文/picture/3.2 API_coperation/degree_assortativity_coefficient.svg", format='svg', bbox_inches='tight', dpi=600)
    # plt.savefig("E:/IntelligentServiceLab/动态分析论文/picture/3.2 API_coperation/degree_assortativity_coefficient.png", format='png', dpi=600)
    # plt.savefig("E:/IntelligentServiceLab/动态分析论文/picture/3.2 API_coperation/degree_assortativity_coefficient.tif", format='tif', dpi=600)
    plt.show()
